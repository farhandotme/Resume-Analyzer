...
const Story2 = () => {
    ...
    return (
        <section className='relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-white transition-colors duration-300 dark:bg-black'>
            <div
            ...
            <div className='relative z-10 mx-auto flex max-w-xl -translate-y-4 flex-col items-center px-6 text-center'>
                <motion.div
                    initial={
                        reduceMotion
                            ? {
                ...
                >
                    ...
                    <motion.h1
                        ...
                        className='select-none text-[110px] font-medium leading-none tracking-[-0.02em] tabular-nums text-zinc-900 dark:text-zinc-100 sm:text-[136px]'
                    >
                        {roundedScore}
                    </motion.h1>
                </motion.div>
