...
const Story2 = () => {
    ...
    const [score, setScore] = useState(reduceMotion ? ATS_SCORE : 0);
    ...
    useEffect(() => {
        ...
        const controls = animate(0, ATS_SCORE, {
            duration: 0.95,
            delay: 0.35,
            ease: [0.22, 1, 0.36, 1],
            onUpdate(value) {
        ...
        <section className='relative flex h-screen w-full items-center justify-center overflow-hidden bg-white'>
            ...
            <div className='relative z-10 flex flex-col items-center px-6 text-center'>
                ...
                <motion.p
                    ...
                    className='mt-2 text-[13px] font-medium uppercase tracking-[0.4em] text-zinc-500'
                >
                    ATS Score
                </motion.p>
                ...
                {ONE_LINER && (
                    <motion.p
                        ...
                        className='mt-10 max-w-120 text-[18px] leading-relaxed text-zinc-600'
                    >
                        {ONE_LINER}
                    </motion.p>
                )}
                ...
                >
                    ...
                    <div className='text-center'>
                        <p className='text-lg font-medium text-zinc-900'>{HIRE_PROBABILITY}</p>
