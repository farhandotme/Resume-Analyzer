...
const SunIcon = () => (
    <svg viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' className='h-6 w-6 max-[649.9px]:h-5.5 max-[649.9px]:w-5.5' aria-hidden>
...
const PlayIcon = () => (
    <svg viewBox='0 0 24 24' fill='currentColor' className='ml-1 h-8 w-8 max-[649.9px]:ml-0 max-[649.9px]:h-6 max-[649.9px]:w-6' aria-hidden>
        <path d='M5.5 3.5v17l14-8.5-14-8.5Z' />
    </svg>
);

const PauseIcon = () => (
    <svg viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='1.8' className='h-7 w-7 max-[649.9px]:h-6 max-[649.9px]:w-6' aria-hidden>
...
const StoryControls = () => {
    ...
    const [activeControl, setActiveControl] = useState<'play' | 'theme' | null>(null);
    ...
    const handleThemeToggle = (event: React.MouseEvent) => {
        ...
        if (window.matchMedia('(max-width: 649.9px)').matches) {
            setActiveControl((current) => (current === 'theme' ? null : 'theme'));
        }
    };
    ...
    const handlePlayPause = (event: React.MouseEvent) => {
        ...
        if (window.matchMedia('(max-width: 649.9px)').matches) {
            setActiveControl((current) => (current === 'play' ? null : 'play'));
        }
    };
    ...
    return (
        <div
            className='fixed right-4 top-7.5 z-70 flex items-center gap-1 rounded-full px-2 py-1.5 max-[649.9px]:right-2 max-[649.9px]:top-3 max-[649.9px]:gap-0.5 max-[649.9px]:px-1 max-[649.9px]:py-1'
        ...
        >
            ...
            >
                ...
                <div className='grid grid-cols-[0fr] transition-[grid-template-columns] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] min-[650px]:group-hover:grid-cols-[1fr] max-[649.9px]:hidden'>
                    <div className={`overflow-hidden opacity-0 transition-opacity duration-300 ease-out min-[650px]:group-hover:opacity-100 ${activeControl === 'play' ? 'max-[649.9px]:opacity-100' : ''}`}>
                        <span className='block whitespace-nowrap pl-2 text-sm font-medium max-[649.9px]:pl-1.5 max-[649.9px]:text-xs'>{paused ? 'Play' : 'Pause'}</span>
                    </div>
                </div>
            </button>
            ...
            >
                ...
                <div className='grid grid-cols-[0fr] transition-[grid-template-columns] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] min-[650px]:group-hover:grid-cols-[1fr] max-[649.9px]:hidden'>
                    <div className={`overflow-hidden opacity-0 transition-opacity duration-300 ease-out min-[650px]:group-hover:opacity-100 ${activeControl === 'theme' ? 'max-[649.9px]:opacity-100' : ''}`}>
                        <span className='block whitespace-nowrap pl-2 text-sm font-medium max-[649.9px]:pl-1.5 max-[649.9px]:text-xs'>{isDark ? 'Light' : 'Dark'}</span>
                    </div>
                </div>
            </button>
            ...
            >
                ...
                <div className='grid grid-cols-[0fr] transition-[grid-template-columns] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] min-[650px]:group-hover:grid-cols-[1fr]'>
                    <div className='overflow-hidden opacity-0 transition-opacity duration-300 ease-out min-[650px]:group-hover:opacity-100'>
                        <span className='block whitespace-nowrap pl-2 text-sm font-medium max-[649.9px]:pl-1.5 max-[649.9px]:text-xs'>Close</span>
                    </div>
                </div>
            </button>
        </div>
