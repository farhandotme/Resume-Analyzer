...
export default function Chat() {
    ...
    const [leaveConfirmationAction, setLeaveConfirmationAction] = useState<'home' | 'newChat'>('home');
    ...
    const handleHomeClick = () => {
        ...
        setLeaveConfirmationAction('home');
        setShowLeaveConfirmation(true);
    };
    ...
    const handleNewChatClick = () => {
        ...
        setLeaveConfirmationAction('newChat');
        setShowLeaveConfirmation(true);
    };
    ...
    const handleLeaveChat = () => {
        ...
        if (leaveConfirmationAction === 'newChat') {
